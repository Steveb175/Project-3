...
db.once("open", async () => {
  ...
  const workouts = await Workouts.insertMany([
    ...
    },
    {
      ...
      category: "categories[5]._id",
      image: "../images/Abdonimals/cocoons.png"
    },
